...
const ChatMessage: React.FC<ChatMessageProps> = ({
    ...
    return (
        <div className={`flex items-end gap-2 ${message.role === "user" ? "justify-end" : "justify-start"}`} >
            <div className={`flex flex-col items-start p-4 rounded-xl animate-press-in shadow-md sm:text-sm md:text-base ${message.role === "user" ? "bg-primary-verba" : "bg-bg-verba"}`} >
